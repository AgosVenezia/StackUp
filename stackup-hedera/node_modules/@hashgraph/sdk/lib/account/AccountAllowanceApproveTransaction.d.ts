...
export default class AccountAllowanceApproveTransaction extends Transaction {
     ...
     * @returns {AccountAllowanceApproveTransaction}
     */
    _approveTokenNftAllowance(nftId: NftId | string, ownerAccountId: AccountId | string | null, spenderAccountId: AccountId | string, delegatingSpender: AccountId | string | null): AccountAllowanceApproveTransaction;
    /**
     * @param {NftId | string} nftId
     * @param {AccountId | string} ownerAccountId
     * @param {AccountId | string} spenderAccountId
     ...
     * @returns {AccountAllowanceApproveTransaction}
     */
    approveTokenNftAllowanceWithDelegatingSpender(nftId: NftId | string, ownerAccountId: AccountId | string, spenderAccountId: AccountId | string, delegatingSpender: AccountId | string): AccountAllowanceApproveTransaction;
    /**
     * @param {TokenId | string} tokenId
     * @param {AccountId | string | null} ownerAccountId
     * @param {AccountId | string} spenderAccountId
     ...
     * @returns {AccountAllowanceApproveTransaction}
     */
    deleteTokenNftAllowanceAllSerials(tokenId: TokenId | string, ownerAccountId: AccountId | string, spenderAccountId: AccountId | string): AccountAllowanceApproveTransaction;
    /**
     * @override
     * @protected
